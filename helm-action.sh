...
# input prep
CREATE_NAMESPACE="${INPUT_CREATE_NAMESPACE:-${CREATE_NAMESPACE}}"
RELEASE="${INPUT_RELEASE:-${RELEASE}}"
CHART="${INPUT_CHART:-${CHART}}"
APP_VERSION="${INPUT_APP_VERSION:-${APP_VERSION}}"
VALUES="${INPUT_VALUES:-${VALUES}}"
VALUES_FILES="${INPUT_VALUES_FILES:-${VALUES_FILES}}"
ATOMIC="${INPUT_ATOMIC:-${ATOMIC}}"
WAIT="${INPUT_WAIT:-${WAIT}}"
TIMEOUT="${INPUT_TIMEOUT:-${TIMEOUT}}"
GITHUB_SUMMARY="${INPUT_GITHUB_SUMMARY:-${GITHUB_SUMMARY}}"
GITHUB_SUMMARY_STRIP_COMMANDS="${INPUT_GITHUB_SUMMARY_STRIP_COMMANDS:-${GITHUB_SUMMARY_STRIP_COMMANDS}}"
